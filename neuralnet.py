#This file is heavily based on Daniel Johnson's midi manipulation code 
# in https://github.com/hexahedria/biaxial-rnn-music-composition
...
def menu(songs):
    ...
    num_epochs = 150 #The number of training epochs that we are going to run. For each epoch we go through the entire data set.
